...
function Client (opts) {
  ...
  self.connector = new WsConnector(self.id, opts.port)
  self.connector.on('connection', onConnection)
...
Client.prototype._onHandshakeAnswer = function (msg, from) {
  ...
  self.connector.connect(msg.data)
}
